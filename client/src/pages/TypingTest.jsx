...
export default function TypingTest() {
  ...
  const activeWordIndex = useMemo(() => activeWordTokenIndex(referenceTokens, cursor), [cursor, referenceTokens]);
