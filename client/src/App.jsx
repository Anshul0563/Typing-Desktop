...
const AppLayout = lazy(() =>
  import("./layouts/AppLayout.jsx").then((module) => ({
...
const About = lazy(() =>
  import("./pages/InfoPages.jsx").then((module) => ({ default: module.About })),
);
const Disclaimer = lazy(() =>
  import("./pages/InfoPages.jsx").then((module) => ({
...
const Terms = lazy(() =>
  import("./pages/InfoPages.jsx").then((module) => ({ default: module.Terms })),
);
...
const ManageParagraphs = lazy(
  () => import("./pages/admin/ManageParagraphs.jsx"),
);
  ...
  return (
    <Suspense fallback={<Loader label="Loading page…" />}>
      <Routes>
        ...
        <Route
          path="/admin/login"
          element={<AuthPage mode="login" adminOnly />}
        />
        ...
        <Route element={<ProtectedRoute admin />}>
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="paragraphs" element={<ManageParagraphs />} />
